<?php 
	//include file model
	include "Admin/Models/CartModel.php";
	class CartController extends Controller{
		...
		public function order(){
			...
			$this->renderHTML("Admin/Views/OrderView.php",array("data"=>$data,"numPage"=>$numPage));
        }
        public function orderDetail(){
            $id = isset($_GET["id"]) && is_numeric($_GET["id"])?$_GET["id"]:0;
            $data = $this->listProduct($id);
            $this->renderHTML("Admin/Views/OrderDetailView.php",array("data"=>$data,"id"=>$id));
